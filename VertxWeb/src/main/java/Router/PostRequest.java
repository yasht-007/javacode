...
public class PostRequest extends AbstractVerticle {
    ...
    public void start(Promise<Void> startPromise) throws Exception {
        ...
        router.route().handler(BodyHandler.create().setUploadsDirectory("uploads").setDeleteUploadedFilesOnEnd(true).setMergeFormAttributes(true));
        ...
        router.post("/uploadstatus").handler(context -> {
