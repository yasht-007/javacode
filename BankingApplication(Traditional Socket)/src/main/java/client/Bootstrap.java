...
public class Bootstrap
{
    ...
    private static DataInputStream socketinputreader = null;
    ...
    public static void main(String[] args)
    {
        ...
        try
        {
            ...
            socket.connect(new InetSocketAddress(InetAddress.getByName("10.20.40.158"), 9999));
    ...
    public static void login()
    {
        try
        {
            ...
            if (socketinputreader.readUTF().equalsIgnoreCase("ok"))
            {
